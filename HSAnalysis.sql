...
/*
--BCP Script
bcp dbo.tblHomeSpotter in D:\Edina\HomeSpotterFeed\12Dec17\edina_contata_sessions.csv -S tcp:contata.database.windows.net -d Edina -U contata.admin@contata -P C@ntata123 -a 16384 -b 20000 -q -c -t","
*/

select count(*) from tblHomeSpotter_DT --301861

select count(*) from tblHomeSpotter --24068
...
select TOP 100 * from tblHomeSpotter
...
select 
	...
	,[device_id]
	,ip_address
	,count(1) As RecCount from tblHomeSpotter_DT
...
select count(DISTINCT [user_id]) from tblHomeSpotter_DT --31555
SELECT COUNT(DISTINCT [user]) from tblHomeSpotter_DT --3576
...
from tblHomeSpotter_DT
--where 
--	DAY(session_start_utc)= 8
--	and device_id IS NOT NULL
group by CAST(session_start_utc as DATE)
order by CAST(session_start_utc as DATE)
 --device_id
--7154 distinct device_id count on 11Dec2017
--8173 distinct device_id count on 10Dec2017
--8297 09Dec2017
--7252 08Dec2017
