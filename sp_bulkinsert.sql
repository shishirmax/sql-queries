ALTER PROCEDURE [homeSpotter].[usp_LoadHSFlatToBCP]
	(
...
BEGIN
	...
	BEGIN TRY
		DECLARE
			...
			@BcpTable				NVARCHAR(127)  

		SET		@BcpTable = 'homeSpotter.tblHomeSpotter_bcp'
		...
		SET @sql= 'BULK INSERT ' + @BcpTable + ' FROM '''+ @FileName + ''' WITH (DATA_SOURCE = '''+@container+''', FORMAT = ''CSV'', FIELDTERMINATOR  = '','', FIRSTROW = 2);'          
			EXEC SP_EXECUTESQL @sql 
