...
*/
 select count(1),memo from zerorez.March_2018_Quickbook_Dump
 ...
 */
 ...
 select count(1),Name from zerorez.March_2018_Quickbook_Dump
 group by Name
 select count(distinct Name) from zerorez.March_2018_Quickbook_Dump

 select * from zerorez.March_2018_Quickbook_Dump
 where Name like '%[0-9]%'
 /*
...
select count(1),Item from zerorez.March_2018_Quickbook_Dump
where Item is not null
group by Item

select count(distinct Item) from zerorez.March_2018_Quickbook_Dump
...
select count(1) As RecordsCount,Item,[Item Description] from zerorez.March_2018_Quickbook_Dump
where [Item Description] is null
group by Item,[Item Description]
order by 1 desc

select count(distinct [Item Description]) from zerorez.March_2018_Quickbook_Dump
